function eventListener(event) { console.log(event); }
...
const horizontalTick = window.document.querySelector("horizontal-axis > axis-tick");
...
const horizontalTickLabel = window.document.querySelector("horizontal-axis > axis-tick > tick-label");
horizontalTickLabel.addEventListener("mouseenter", eventListener);
horizontalTickLabel.addEventListener("mouseleave", eventListener);
horizontalTickLabel.addEventListener("mousemove", eventListener);
horizontalTickLabel.addEventListener("mouseover", eventListener);
horizontalTickLabel.addEventListener("mouseout", eventListener);
horizontalTickLabel.addEventListener("mousedown", eventListener);
horizontalTickLabel.addEventListener("mouseup", eventListener);
horizontalTickLabel.addEventListener("click", eventListener);
horizontalTickLabel.addEventListener("focus", eventListener);
horizontalTickLabel.addEventListener("blur", eventListener);
...
const verticalTick = window.document.querySelector("vertical-axis > axis-tick");
...
const verticalTickLabel = window.document.querySelector("vertical-axis > axis-tick > tick-label");
verticalTickLabel.addEventListener("mouseenter", eventListener);
verticalTickLabel.addEventListener("mouseleave", eventListener);
verticalTickLabel.addEventListener("mousemove", eventListener);
verticalTickLabel.addEventListener("mouseover", eventListener);
verticalTickLabel.addEventListener("mouseout", eventListener);
verticalTickLabel.addEventListener("mousedown", eventListener);
verticalTickLabel.addEventListener("mouseup", eventListener);
verticalTickLabel.addEventListener("click", eventListener);
verticalTickLabel.addEventListener("focus", eventListener);
verticalTickLabel.addEventListener("blur", eventListener);
