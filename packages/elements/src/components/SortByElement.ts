...
/**
 * `hdml-sort-by:connected`, `hdml-sort-by:changed`,
 * `hdml-sort-by:request`, `hdml-sort-by:disconnected` events details
 * interface.
 */
export interface SortByDetail {
  sortBy: SortByElement;
}

/**
 * `SortByElement` class. Adds a new `HTML` tag (default
 * `hdml-sort-by`) which is the root element to describe the sorting
 * of the data frame. Contains a list of fields by which sorting will
 * be performed.
 */
export class SortByElement extends UnifiedElement {
  ...
  public connectedCallback(): void {
    ...
    if (this._frame) {
      this._frame.dispatchEvent(
        new CustomEvent<SortByDetail>("hdml-sort-by:connected", {
          cancelable: false,
          composed: false,
          bubbles: false,
          detail: {
  ...
  public disconnectedCallback(): void {
    ...
    if (this._frame) {
      this._frame.dispatchEvent(
        new CustomEvent<SortByDetail>("hdml-sort-by:disconnected", {
          cancelable: false,
          composed: false,
          bubbles: false,
          detail: {
  ...
  private _dispatchChangedEvent(): void {
    this.dispatchEvent(
      new CustomEvent<SortByDetail>("hdml-sort-by:changed", {
        cancelable: false,
        composed: false,
        bubbles: false,
        detail: {
